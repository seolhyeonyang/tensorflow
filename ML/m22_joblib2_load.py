...
# joblib.dump(model, '/study2/_save/xgb_save/m22_joblib.dat')


# 불러오기
# model = pickle.load(open('/study2/_save/xgb_save/m21_pickle.dat', 'rb'))
# print('불러왔다.')

model = joblib.load('/study2/_save/xgb_save/m22_joblib.dat')
