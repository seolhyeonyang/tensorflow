...
# print(randidx)              # [22330 41369 48593 ... 57057 52364 53520]
...
hist = model.fit(x_train, y_train, epochs=5000, batch_size=1000, callbacks=[es], verbose=2, validation_split=0.2)
