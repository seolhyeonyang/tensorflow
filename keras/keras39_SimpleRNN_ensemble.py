...
simplernn1 = SimpleRNN(64, activation='relu')(input1)
dense1 = Dense(32, activation='relu')(simplernn1)
...
simplernn2 = SimpleRNN(32, activation='relu')(input2)
dense11 = Dense(16, activation='relu')(simplernn2)
