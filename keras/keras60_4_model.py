...
model = Sequential()
model.add(Conv2D(filters=30, kernel_size=(3,3), padding='same', input_shape=( 28, 28, 1)))
...
hist = model.fit(x_train, y_train, epochs=5000, batch_size=999, callbacks=[es], verbose=2, validation_split=0.1)
