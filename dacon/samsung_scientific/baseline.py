...
#         img.save(f'/study2/dacon/samsung_scientific/_data/_train_imgs/{file}.png')

sample_img = cv2.imread('/study2/dacon/samsung_scientific/_data/_train_imgs/dev_0.png')
...
save_path = f'/study2/dacon/samsung_scientific/modles/best_model.pt'
...
imgs = ('/study2/dacon/samsung_scientific/_data/_train_imgs/'+train.uid+'.png').to_numpy()
...
submission = pd.read_csv('/study2/dacon/samsung_scientific/_data/sample_submission.csv')
...
for idx, row in tqdm(test.iterrows()):
    ...
    if m != None:
        img = Draw.MolToImage(m, size=(300,300))
        img.save(f'/study2/dacon/samsung_scientific/_data/_test_imgs/{file}.png')

test_seqs = tokenizer.txt2seq(test.SMILES)
test_imgs = ('/study2/dacon/samsung_scientific/_data/_test_imgs/'+test.uid+'.png').to_numpy()
