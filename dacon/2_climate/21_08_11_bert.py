...
checkpoint_path = os.path.join(model_name, '/study2/dacon/2_climate/_save/weights.h5')
...
# 학습과 eval 시작
history = cls_model.fit(train_inputs, train_labels, epochs=2, batch_size=1000,
...
sample_submission.to_csv('/study2/dacon/2_climate/_save/bert_baseline.csv', index=False)