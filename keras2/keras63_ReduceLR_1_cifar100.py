...
#! 지정은 컴파일에서 하고, 실행은 핏에서 된다.

from tensorflow.keras.callbacks import EarlyStopping, ReduceLROnPlateau

es = EarlyStopping(monitor= 'val_loss', patience=10, mode='min', verbose=1)

reduce_lr = ReduceLROnPlateau(monitor= 'val_loss', patience=5, mode='auto', verbose=1, factor=0.005)
#! val_loss가 5번 안에 변화가 없으면 factor=0.5 만큼 감축 된다.
